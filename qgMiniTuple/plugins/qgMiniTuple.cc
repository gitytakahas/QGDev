...
private:
  ...
  float rho, pt, eta, axis1, axis2, ptD, bTag, motherMass, pt_dr_log;
  int nEvent, nPileUp, nPriVtxs, multiplicity, charged_multiplicity, neutral_multiplicity, chadmult, nhadmult, partonId, jetIdLevel, nGenJetsInCone, nGenJetsForGenParticle, nJetsForGenParticle, motherId, charge;
